...
{
    // Datos de entrada para crear o modificar un proveedor
    ...
    public class ProveedorCreateDto
    {
        ...
        public string DescProveedor { get; set; } = string.Empty;
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "La {0} es obligatoria")]
        [StringLength(25, ErrorMessage = "La {0} no debe superar los {1} caracteres")]
        [RegularExpression(@"^[\p{L}\p{N}\p{P}\p{Z}]*$", ErrorMessage = "No se permiten caracteres especiales ni emojis")]
