...
{
    /* Datos de entrada para crear una factura de venta
     ...
     *  - CifCliente y RazonSocial → se copian del registro del cliente en el momento 
     *      de crear la factura como dato histórico*/
    public class FacturaVentaCabeceraCreateDto
    {
        ...
        public List<FacturaVentaLineaCreateDto> Lineas { get; set; } = new();
    }
}
